...
@inline function obj_val_hess(capsule::P1,
           cone::P2,
           x::SVector{nx,T1},
           s::SVector{nz,T7},
           z::SVector{nz,T2},
   ...
   return ForwardDiff.gradient(_θ -> lag_con_part(capsule,cone,x,s,z,_θ[idx_r1],_θ[idx_p1],_θ[idx_r2],_θ[idx_p2],idx_ort,idx_soc1,idx_soc2), [capsule.r;capsule.p;cone.r;cone.p]),
          ForwardDiff.hessian(_θ -> lag_con_part(capsule,cone,x,s,z,_θ[idx_r1],_θ[idx_p1],_θ[idx_r2],_θ[idx_p2],idx_ort,idx_soc1,idx_soc2), [capsule.r;capsule.p;cone.r;cone.p])
end
...
@inline function proximity_hessian(prim1::P1,prim2::P2; pdip_tol::Float64 = 1e-6, verbose = false) where {P1 <: AbstractPrimitiveMRP, P2 <: AbstractPrimitiveMRP}
    ...
    ∂α_∂state, ∂α2_∂_state = obj_val_hess(prim1,prim2,x,s,z,idx_ort,idx_soc1,idx_soc2)

    return α, ∂α_∂state, ∂α2_∂_state
end
